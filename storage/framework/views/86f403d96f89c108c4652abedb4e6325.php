...
<?php $__env->startSection('title', 'Vérification d\'identité - ProxiPro'); ?>
    ...
    <?php if(session('success')): ?>
        <div class="verification-card mb-4" style="border: 2px solid #10b981; background: linear-gradient(135deg, #f0fdf4 0%, #dcfce7 100%);">
            <div class="text-center py-3">
                ...
                <h5 class="fw-bold mb-2" style="color: #166534;"><?php echo e(session('success')); ?></h5>
                <?php if(isset($verification) && $verification && $verification->isPending()): ?>
    ...
    <div class="row justify-content-center">
        <div class="col-lg-8">
            ...
            <div class="verification-card mb-4">
                <div class="d-flex justify-content-between align-items-center flex-wrap gap-3">
                    <div>
                        ...
                        <p class="text-muted mb-0">
                            <?php if($user->identity_verified): ?>
                                Votre identité a été vérifiée le <?php echo e($user->identity_verified_at?->format('d/m/Y')); ?>

                            <?php elseif($verification && $verification->isReturned()): ?>
                ...
                <?php if($verification && $verification->isRejected() && $verification->rejection_reason): ?>
                    <div class="alert alert-danger mt-3 mb-0">
                        <strong><i class="fas fa-times-circle me-1"></i>Raison du refus :</strong> <?php echo e($verification->rejection_reason); ?>
            ...
            <?php if($verification && $verification->isReturned() && $verification->admin_message): ?>
                <div class="admin-message-box mb-4">
                    <h5 class="fw-bold mb-2"><i class="fas fa-comment-alt me-2"></i>Message de l'administrateur</h5>
                    <p class="mb-0"><?php echo e($verification->admin_message); ?></p>
                </div>
            <?php endif; ?>

            
            <?php if(isset($missingFields) && count($missingFields) > 0): ?>
                <div class="missing-fields-box mb-4">
                    ...
                    <ul class="mb-2">
                        <?php $__currentLoopData = $missingFields; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $field): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <li><?php echo e($field['label']); ?></li>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </ul>
                    <a href="<?php echo e(route('profile.edit')); ?>" class="btn btn-sm btn-warning">
            ...
            <?php if($verification && $verification->isReturned()): ?>
                <div class="verification-card mb-4">
                    ...
                    <div class="mb-4">
                        ...
                        <div class="doc-status-card <?php echo e($verification->document_front_status === 'approved' ? 'doc-approved' : ($verification->document_front_status === 'rejected' ? 'doc-rejected' : 'doc-pending')); ?>">
                            <span class="doc-status-icon">
                                <?php if($verification->document_front_status === 'approved'): ?>
                                    <i class="fas fa-check-circle"></i>
                                <?php elseif($verification->document_front_status === 'rejected'): ?>
                            ...
                            <div class="d-flex align-items-center gap-3">
                                <?php if($verification->document_front && $verification->document_front_status === 'approved'): ?>
                                    <img src="<?php echo e(asset('storage/' . $verification->document_front)); ?>" class="existing-doc-preview" alt="Recto">
                                <?php endif; ?>
                                <div>
                                    <h6 class="fw-bold mb-1">Recto du document</h6>
                                    <span class="badge <?php echo e($verification->document_front_status === 'approved' ? 'bg-success' : ($verification->document_front_status === 'rejected' ? 'bg-danger' : 'bg-warning')); ?>">
                                        <?php echo e($verification->document_front_status === 'approved' ? 'Approuvé' : ($verification->document_front_status === 'rejected' ? 'Refusé' : 'En attente')); ?>

                                    </span>
                                </div>
                            </div>
                            <?php if($verification->document_front_status === 'rejected' && $verification->document_front_rejection_reason): ?>
                                <div class="rejection-reason">
                                    <i class="fas fa-exclamation-triangle me-1"></i>
                                    <?php echo e($verification->document_front_rejection_reason); ?>
                        ...
                        <div class="doc-status-card <?php echo e($verification->document_back_status === 'approved' ? 'doc-approved' : ($verification->document_back_status === 'rejected' ? 'doc-rejected' : 'doc-pending')); ?>">
                            <span class="doc-status-icon">
                                <?php if($verification->document_back_status === 'approved'): ?>
                                    <i class="fas fa-check-circle"></i>
                                <?php elseif($verification->document_back_status === 'rejected'): ?>
                                    <i class="fas fa-times-circle"></i>
                                <?php else: ?>
                                    <i class="fas fa-clock"></i>
                                <?php endif; ?>
                            ...
                            <div class="d-flex align-items-center gap-3">
                                <?php if($verification->document_back_status === 'approved'): ?>
                                    <img src="<?php echo e(asset('storage/' . $verification->document_back)); ?>" class="existing-doc-preview" alt="Verso">
                                <?php endif; ?>
                                <div>
                                    <h6 class="fw-bold mb-1">Verso du document</h6>
                                    <span class="badge <?php echo e($verification->document_back_status === 'approved' ? 'bg-success' : ($verification->document_back_status === 'rejected' ? 'bg-danger' : 'bg-warning')); ?>">
                                        <?php echo e($verification->document_back_status === 'approved' ? 'Approuvé' : ($verification->document_back_status === 'rejected' ? 'Refusé' : 'En attente')); ?>

                                    </span>
                                </div>
                            </div>
                            <?php if($verification->document_back_status === 'rejected' && $verification->document_back_rejection_reason): ?>
                                <div class="rejection-reason">
                                    <i class="fas fa-exclamation-triangle me-1"></i>
                                    <?php echo e($verification->document_back_rejection_reason); ?>
                        ...
                        <div class="doc-status-card <?php echo e($verification->selfie_status === 'approved' ? 'doc-approved' : ($verification->selfie_status === 'rejected' ? 'doc-rejected' : 'doc-pending')); ?>">
                            <span class="doc-status-icon">
                                <?php if($verification->selfie_status === 'approved'): ?>
                                    <i class="fas fa-check-circle"></i>
                                <?php elseif($verification->selfie_status === 'rejected'): ?>
                                    <i class="fas fa-times-circle"></i>
                                <?php else: ?>
                                    <i class="fas fa-clock"></i>
                                <?php endif; ?>
                            ...
                            <div class="d-flex align-items-center gap-3">
                                <?php if($verification->selfie && $verification->selfie_status === 'approved'): ?>
                                    <img src="<?php echo e(asset('storage/' . $verification->selfie)); ?>" class="existing-doc-preview" alt="Selfie">
                                <?php endif; ?>
                                <div>
                                    <h6 class="fw-bold mb-1">Selfie avec document</h6>
                                    <span class="badge <?php echo e($verification->selfie_status === 'approved' ? 'bg-success' : ($verification->selfie_status === 'rejected' ? 'bg-danger' : 'bg-warning')); ?>">
                                        <?php echo e($verification->selfie_status === 'approved' ? 'Approuvé' : ($verification->selfie_status === 'rejected' ? 'Refusé' : 'En attente')); ?>

                                    </span>
                                </div>
                            </div>
                            <?php if($verification->selfie_status === 'rejected' && $verification->selfie_rejection_reason): ?>
                                <div class="rejection-reason">
                                    <i class="fas fa-exclamation-triangle me-1"></i>
                                    <?php echo e($verification->selfie_rejection_reason); ?>
                        ...
                        <div class="doc-status-card <?php echo e($verification->professional_document_status === 'approved' ? 'doc-approved' : ($verification->professional_document_status === 'rejected' ? 'doc-rejected' : 'doc-pending')); ?>">
                            <span class="doc-status-icon">
                                <?php if($verification->professional_document_status === 'approved'): ?>
                                    <i class="fas fa-check-circle"></i>
                                <?php elseif($verification->professional_document_status === 'rejected'): ?>
                                    <i class="fas fa-times-circle"></i>
                                <?php else: ?>
                                    <i class="fas fa-clock"></i>
                                <?php endif; ?>
                            ...
                            <div class="d-flex align-items-center gap-3">
                                <?php if($verification->professional_document_status === 'approved'): ?>
                                    <img src="<?php echo e(asset('storage/' . $verification->professional_document)); ?>" class="existing-doc-preview" alt="Doc pro">
                                <?php endif; ?>
                                <div>
                                    <h6 class="fw-bold mb-1"><?php echo e($verification->getProfessionalDocumentLabel()); ?></h6>
                                    <span class="badge <?php echo e($verification->professional_document_status === 'approved' ? 'bg-success' : ($verification->professional_document_status === 'rejected' ? 'bg-danger' : 'bg-warning')); ?>">
                                        <?php echo e($verification->professional_document_status === 'approved' ? 'Approuvé' : ($verification->professional_document_status === 'rejected' ? 'Refusé' : 'En attente')); ?>

                                    </span>
                                </div>
                            </div>
                            <?php if($verification->professional_document_status === 'rejected' && $verification->professional_document_rejection_reason): ?>
                                <div class="rejection-reason">
                                    <i class="fas fa-exclamation-triangle me-1"></i>
                                    <?php echo e($verification->professional_document_rejection_reason); ?>
                    ...
                    <?php if($verification->hasRejectedDocuments()): ?>
                    <form action="<?php echo e(route('verification.resubmit')); ?>" method="POST" enctype="multipart/form-data">
                        <?php echo csrf_field(); ?>
                        <h6 class="fw-bold mb-3"><i class="fas fa-cloud-upload-alt me-2 text-primary"></i>Remplacer les documents refusés :</h6>

                        <?php if($verification->document_front_status === 'rejected'): ?>
                        <div class="mb-3">
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <?php if($verification->document_back_status === 'rejected'): ?>
                        <div class="mb-3">
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <?php if($verification->selfie_status === 'rejected'): ?>
                        <div class="mb-3">
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <?php if($verification->professional_document_status === 'rejected'): ?>
                        <div class="mb-3">
                            <label class="upload-zone w-100" id="resubProDocZone">
                                ...
                                <h5 class="mb-1">Nouveau <?php echo e($verification->getProfessionalDocumentLabel()); ?></h5>
                                <p class="text-danger small mb-0">Ce document a été refusé - veuillez le remplacer</p>
                                <img id="resubProDocPreview" class="upload-preview">
                            </label>
                            <?php $__errorArgs = ['professional_document'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
            ...
            <?php elseif(!$user->identity_verified && (!$verification || !$verification->isPending())): ?>
            <div class="verification-card">
                ...
                <form id="pageVerificationForm" action="<?php echo e(route('verification.store')); ?>" method="POST" enctype="multipart/form-data" novalidate>
                    <?php echo csrf_field(); ?>
                        ...
                        <div class="row g-3">
                            <div class="col-md-4">
                                <label class="document-type-card" data-type="id_card">
                                    <input type="radio" name="document_type" value="id_card" class="d-none" <?php echo e(old('document_type') == 'id_card' ? 'checked' : ''); ?> required>
                            ...
                            <div class="col-md-4">
                                <label class="document-type-card" data-type="passport">
                                    <input type="radio" name="document_type" value="passport" class="d-none" <?php echo e(old('document_type') == 'passport' ? 'checked' : ''); ?>>
                            ...
                            <div class="col-md-4">
                                <label class="document-type-card" data-type="driver_license">
                                    <input type="radio" name="document_type" value="driver_license" class="d-none" <?php echo e(old('document_type') == 'driver_license' ? 'checked' : ''); ?>>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <label class="upload-zone w-100" id="pageProDocZone">
                                    ...
                                    <input type="hidden" name="professional_document_type" value="<?php echo e($proDocType ?? ''); ?>">
                                    <i class="fas fa-building d-block"></i>
                                    <h5 class="mb-1">
                                        <?php if(isset($proDocType) && $proDocType === 'kbis'): ?>
                                            Extrait Kbis
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="d-flex justify-content-between align-items-center pt-3">
                        ...
                        <button type="submit" class="btn-verify" <?php echo e((isset($missingFields) && count($missingFields) > 0) ? 'disabled' : ''); ?>>
                            <i class="fas fa-paper-plane me-2"></i>
            ...
            <div class="verification-card">
                <div class="text-center mb-4">
                    ...
                    <p class="text-muted">
                        Soumise le <strong><?php echo e($verification->submitted_at?->format('d/m/Y à H:i') ?? $verification->created_at->format('d/m/Y à H:i')); ?></strong>
                    </p>
                </div>
                ...
                <div class="text-center">
                    <form action="<?php echo e(route('verification.cancel')); ?>" method="POST" class="d-inline">
                        <?php echo csrf_field(); ?>
            ...
            <?php elseif($user->identity_verified): ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\PC\Desktop\MASSIWANI V2\resources\views/verification/index.blade.php ENDPATH**/ ?>