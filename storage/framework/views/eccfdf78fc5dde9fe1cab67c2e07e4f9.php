...
<div class="filter-bar-container">
    <div class="filter-bar">
        ...
        <div class="toggle-group">
            ...
            <a href="<?php echo e(route('ads.index')); ?>" class="toggle-btn active" id="toggleMission">
    ...
    <div id="missionsSection">
        ...
        <div class="feed-layout">
            ...
            <div class="feed-main">
                ...
                ?>
                <?php if($highlightedAds->count() > 0): ?>
                <div class="highlighted-ads-section">
                    <?php $__currentLoopData = $highlightedAds; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $hAd): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <?php
                        $hPhotos = $hAd->photos ?? [];
                    ...
                    ?>
                    <div class="highlighted-ad-card <?php echo e($hAd->is_urgent ? 'urgent' : 'boosted'); ?>"
                        ...
                        <div class="highlighted-ad-img">
                            <?php if($hPhoto): ?>
                                <img src="<?php echo e($hPhoto); ?>" alt="<?php echo e($hAd->title); ?>">
                            <?php else: ?>
                        ...
                        <div class="highlighted-ad-body">
                            <div class="highlighted-ad-title"><?php echo e(Str::limit($hAd->title, 50)); ?></div>
                            <div class="highlighted-ad-desc"><?php echo e(Str::limit($hAd->description, 100)); ?></div>
                            <div class="highlighted-ad-meta">
                                <div class="highlighted-ad-user">
                                    <?php if($hAd->user && $hAd->user->avatar): ?>
                                        <img src="<?php echo e(asset('storage/' . $hAd->user->avatar)); ?>" alt="">
                                    <?php else: ?>
                                        <div class="highlighted-ad-user-placeholder"><?php echo e(strtoupper(substr($hAd->user->name ?? 'U', 0, 1))); ?></div>
                                    <?php endif; ?>
                                    <span><?php echo e(Str::limit($hAd->user->name ?? 'Utilisateur', 20)); ?></span>
                                </div>
                                <?php if($hAd->price): ?>
                                    <span class="highlighted-ad-price"><?php echo e(number_format($hAd->price, 0, ',', ' ')); ?> €</span>
                                <?php endif; ?>
                            </div>
                        </div>
                    </div>
                ...
                <div class="featured-ads-carousel">
                    <div class="featured-ads-wrapper">
                        ...
                        <div class="featured-ads-track" id="featuredAdsTrack">
                            <?php $__currentLoopData = $featuredAds; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $fAd): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <?php
                                $fPhotos = $fAd->photos ?? [];
                            ...
                            <a href="#" class="featured-ad-card"
                               ...
                               onclick="event.preventDefault(); openAdDetail(this)">
                                <div class="featured-ad-img">
                                    <?php if($fPhoto): ?>
                                        <img src="<?php echo e($fPhoto); ?>" alt="<?php echo e($fAd->title); ?>">
                                    <?php else: ?>
                                ...
                                <div class="featured-ad-info">
                                    <div class="featured-ad-title"><?php echo e(Str::limit($fAd->title, 30)); ?></div>
                                    <div class="featured-ad-meta">
                                        <?php if($fAd->user && $fAd->user->avatar): ?>
                                            <img src="<?php echo e(asset('storage/' . $fAd->user->avatar)); ?>" alt="" class="featured-ad-user-avatar">
                                        <?php endif; ?>
                                        <span><?php echo e(Str::limit($fAd->user->name ?? 'Utilisateur', 15)); ?></span>
                                    </div>
                                    <div class="featured-ad-bottom">
                                        <?php if($fAd->price): ?>
                                        <span class="featured-ad-price"><?php echo e(number_format($fAd->price, 0, ',', ' ')); ?> €</span>
                                        <?php endif; ?>
                                        <span class="featured-ad-cat"><?php echo e(Str::limit($fAd->category ?? '', 15)); ?></span>
                                    </div>
                                </div>
                            </a>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            ...
            <?php if($loopIndex > 0 && $loopIndex % 5 === 0 && isset($showcasePros) && $showcasePros->count() > 0): ?>
                <?php $proChunk = (int)(($loopIndex / 5) - 1); ?>
                <?php if(isset($showcasePros[$proChunk * 2]) || isset($showcasePros[$proChunk * 2 + 1])): ?>
                <div class="pro-inline-card">
                    ...
                    <div class="pro-inline-grid">
                        <?php for($pi = $proChunk * 2; $pi <= min($proChunk * 2 + 1, $showcasePros->count() - 1); $pi++): ?>
                            <?php if(isset($showcasePros[$pi])): ?>
                            <a href="<?php echo e(route('profile.public', $showcasePros[$pi]->id)); ?>" class="pro-inline-item">
                                <div class="pro-inline-avatar">
                                    <?php if($showcasePros[$pi]->avatar): ?>
                                        <img src="<?php echo e(asset('storage/' . $showcasePros[$pi]->avatar)); ?>" alt="">
                                    <?php else: ?>
                                        <div class="pro-inline-avatar-placeholder"><?php echo e(strtoupper(substr($showcasePros[$pi]->name, 0, 1))); ?></div>
                                    <?php endif; ?>
                                </div>
                                <div>
                                    <div class="pro-inline-name"><?php echo e(Str::limit($showcasePros[$pi]->name, 16)); ?></div>
                                    <div class="pro-inline-cat"><?php echo e(Str::limit($showcasePros[$pi]->profession ?? $showcasePros[$pi]->bio ?? 'Professionnel', 25)); ?></div>
                                </div>
                            </a>
                            <?php endif; ?>
                        <?php endfor; ?>
        ...
        <div class="row">
            ...
            <div class="col-lg-2 col-md-6 mb-4">
                ...
                <ul class="footer-links">
                    ...
                    <li><a href="<?php echo e(route('ads.create')); ?>">Publier une annonce</a></li>
...
Décrivez votre projet, lieu, budget estimé, etc."></textarea>
    ...
    function submitCategoryNeed() {
        ...
        closeCategoryPopup();
        window.location.href = '<?php echo e(route("ads.create")); ?>?' + params.toString();
    }
