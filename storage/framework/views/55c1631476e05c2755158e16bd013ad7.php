...
<?php $__env->startSection('title', 'Tableau de bord - Espace Pro'); ?>
...
<div class="pro-content-header">
    <div>
        ...
        <h1>Bonjour, <?php echo e(Auth::user()->company_name ?? Auth::user()->name); ?> 👋</h1>
        <p class="text-muted mb-0" style="font-size: 0.88rem;">Voici un aperçu de votre activité professionnelle</p>
    </div>
    <div class="d-flex gap-2">
        <a href="<?php echo e(route('pro.quotes.create')); ?>" class="btn btn-pro-outline">
            <i class="fas fa-plus me-1"></i> Nouveau devis
        </a>
        <a href="<?php echo e(route('ads.create')); ?>" class="btn btn-pro-primary">
...
<div class="row g-3 mb-4">
    <div class="col-6 col-md-3">
        <div class="pro-stat-card">
            ...
            <div class="pro-stat-value"><?php echo e($stats['total_clients']); ?></div>
    ...
    <div class="col-6 col-md-3">
        <div class="pro-stat-card">
            ...
            <div class="pro-stat-value"><?php echo e($stats['total_quotes']); ?></div>
    ...
    <div class="col-6 col-md-3">
        <div class="pro-stat-card">
            ...
            <div class="pro-stat-value"><?php echo e(number_format($stats['total_revenue'], 0, ',', ' ')); ?>€</div>
    ...
    <div class="col-6 col-md-3">
        <div class="pro-stat-card">
            ...
            <div class="pro-stat-value"><?php echo e($stats['average_rating']); ?><span style="font-size: 0.8rem; color: var(--pro-text-secondary);">/5</span></div>
            <div class="pro-stat-label">Note moyenne (<?php echo e($stats['reviews_count']); ?> avis)</div>
        </div>
    </div>
</div>
...
<div class="row g-3 mb-4">
    <div class="col-6 col-lg-3">
        <div class="pro-card text-center py-3">
            <div class="text-primary fw-bold fs-4"><?php echo e($stats['monthly_revenue']); ?>€</div>
            <div class="text-muted" style="font-size: 0.78rem;">Revenus ce mois</div>
        </div>
    </div>
    <div class="col-6 col-lg-3">
        <div class="pro-card text-center py-3">
            <div class="text-warning fw-bold fs-4"><?php echo e($stats['pending_quotes']); ?></div>
            <div class="text-muted" style="font-size: 0.78rem;">Devis en attente</div>
        </div>
    </div>
    <div class="col-6 col-lg-3">
        <div class="pro-card text-center py-3">
            <div class="text-danger fw-bold fs-4"><?php echo e($stats['unpaid_invoices']); ?></div>
            <div class="text-muted" style="font-size: 0.78rem;">Factures impayées</div>
        </div>
    </div>
    <div class="col-6 col-lg-3">
        <div class="pro-card text-center py-3">
            <div class="text-success fw-bold fs-4"><?php echo e($stats['active_ads']); ?></div>
    ...
    <div class="col-lg-6">
        <div class="pro-card">
            <div class="pro-card-title">
                ...
                <a href="<?php echo e(route('pro.quotes')); ?>" class="ms-auto" style="font-size: 0.8rem; color: var(--pro-primary);">Voir tout →</a>
            </div>
            <?php if($recentQuotes->isEmpty()): ?>
                <div class="pro-empty py-4">
                    <div class="pro-empty-icon">📄</div>
                    <p class="mb-2">Aucun devis pour le moment</p>
                    <a href="<?php echo e(route('pro.quotes.create')); ?>" class="btn btn-pro-primary btn-sm">Créer un devis</a>
                </div>
            <?php else: ?>
                <div class="table-responsive">
                    <table class="pro-table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td><a href="<?php echo e(route('pro.quotes.show', $quote->id)); ?>" style="color: var(--pro-primary); font-weight: 600;"><?php echo e($quote->quote_number); ?></a></td>
                                <td><?php echo e(Str::limit($quote->client_name, 20)); ?></td>
                                <td class="fw-bold"><?php echo e(number_format($quote->total, 2, ',', ' ')); ?>€</td>
                                <td><span class="pro-status pro-status-<?php echo e($quote->getStatusColor()); ?>"><?php echo e($quote->getStatusLabel()); ?></span></td>
                            </tr>
    ...
    <div class="col-lg-6">
        <div class="pro-card">
            <div class="pro-card-title">
                ...
                <a href="<?php echo e(route('pro.invoices')); ?>" class="ms-auto" style="font-size: 0.8rem; color: var(--pro-primary);">Voir tout →</a>
            </div>
            <?php if($recentInvoices->isEmpty()): ?>
                <div class="pro-empty py-4">
                    <div class="pro-empty-icon">🧾</div>
                    <p class="mb-2">Aucune facture encore</p>
                    <a href="<?php echo e(route('pro.invoices.create')); ?>" class="btn btn-pro-primary btn-sm">Créer une facture</a>
                </div>
            <?php else: ?>
                <div class="table-responsive">
                    <table class="pro-table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td><a href="<?php echo e(route('pro.invoices.show', $invoice->id)); ?>" style="color: var(--pro-primary); font-weight: 600;"><?php echo e($invoice->invoice_number); ?></a></td>
                                <td><?php echo e(Str::limit($invoice->client_name, 20)); ?></td>
...
<div class="pro-card mt-3">
    <div class="pro-card-title">
        ...
        <a href="<?php echo e(route('pro.clients')); ?>" class="ms-auto" style="font-size: 0.8rem; color: var(--pro-primary);">Voir tout →</a>
    </div>
        ...
        <div class="row g-3">
            ...
            <div class="col-md-6 col-lg-4">
                <div class="d-flex align-items-center gap-3 p-3" style="background: #f8fafc; border-radius: 12px;">
                    ...
                    <div>
                        <div class="fw-semibold" style="font-size: 0.9rem;"><?php echo e($client->name); ?></div>
                        <div class="text-muted" style="font-size: 0.78rem;">
                            <?php echo e($client->city ?? 'Ville non renseignée'); ?>

                            · <span class="pro-status-<?php echo e($client->getStatusColor()); ?>"><?php echo e($client->getStatusLabel()); ?></span>
                        </div>
                    </div>
                </div>
            </div>
...
<div class="pro-card mt-3" style="background: linear-gradient(135deg, rgba(249,115,22,0.05), rgba(239,68,68,0.05)); border-color: #fed7aa;">
    <div class="d-flex align-items-center gap-3 flex-wrap">
        ...
        <a href="<?php echo e(route('pro.subscription')); ?>" class="btn btn-pro-primary">
...
<div class="pro-card mb-4" style="background: linear-gradient(135deg, #4f46e5 0%, #7c3aed 100%); border: none; color: white; padding: 24px 28px;">
    <div class="d-flex align-items-center gap-4 flex-wrap">
        ...
        <div class="d-flex gap-2 flex-wrap flex-shrink-0">
            ...
            <a href="<?php echo e(route('pricing.index')); ?>" class="btn"
...
<div class="row g-4 mb-4">
    ...
    <div class="col-12">
        <div class="teaser-locked">
            ...
            <div class="row g-3">
                <?php $__currentLoopData = [['fas fa-users','#3b82f6','Clients','—'],['fas fa-file-alt','#f59e0b','Devis','—'],['fas fa-euro-sign','#10b981','Chiffre d\'affaires','—€'],['fas fa-star','#ec4899','Note moyenne','—/5']]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $s): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="col-6 col-md-3">
                    <div class="pro-stat-card">
                        <div class="pro-stat-icon" style="background: rgba(0,0,0,0.05); color: <?php echo e($s[1]); ?>;"><i class="<?php echo e($s[0]); ?>"></i></div>
                        <div class="pro-stat-value" style="filter: blur(6px); user-select: none;"><?php echo e($s[3]); ?></div>
                        <div class="pro-stat-label"><?php echo e($s[2]); ?></div>
                    </div>
                </div>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            </div>
...
<div class="pro-card" style="background: linear-gradient(135deg, rgba(79,70,229,0.04) 0%, rgba(124,58,237,0.04) 100%); border-color: #c7d2fe; text-align: center; padding: 40px 24px;">
    ...
    <div class="d-flex gap-3 justify-content-center flex-wrap">
        ...
        <a href="<?php echo e(route('pricing.index')); ?>" class="btn btn-pro-outline" style="padding: 12px 28px; font-size: 0.95rem;">
            Voir les tarifs
        </a>
    </div>
</div>
...
<?php echo $__env->make('pro.layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\PC\Desktop\MASSIWANI V2\resources\views/pro/dashboard.blade.php ENDPATH**/ ?>