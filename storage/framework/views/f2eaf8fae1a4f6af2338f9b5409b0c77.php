...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'Espace Pro - ProxiPro'); ?></title>
...
<body>
    ...
    <nav class="pro-topbar">
        <div class="pro-topbar-left">
            ...
            <a href="<?php echo e(route('pro.dashboard')); ?>" class="pro-topbar-brand">
        ...
        <div class="pro-topbar-right">
            <a href="<?php echo e(route('feed')); ?>" class="pro-topbar-btn" title="Retour au feed">
                <i class="fas fa-home"></i>
            </a>
            <a href="<?php echo e(route('messages.index')); ?>" class="pro-topbar-btn" title="Messages">
                <i class="fas fa-envelope"></i>
                <?php if(Auth::user()->unreadMessagesCount() > 0): ?>
                    <span class="badge-count"><?php echo e(Auth::user()->unreadMessagesCount()); ?></span>
                <?php endif; ?>
            </a>
            ...
            <div class="dropdown">
                <a href="#" class="pro-user-menu dropdown-toggle" data-bs-toggle="dropdown" aria-expanded="false">
                    <?php if(Auth::user()->avatar): ?>
                        <img src="<?php echo e(asset('storage/' . Auth::user()->avatar)); ?>" class="pro-user-avatar" alt="">
                    <?php else: ?>
                        <div class="pro-user-avatar"><?php echo e(strtoupper(substr(Auth::user()->name, 0, 1))); ?></div>
                    <?php endif; ?>
                    <div class="pro-user-info d-none d-md-flex">
                        <span class="pro-user-name"><?php echo e(Str::limit(Auth::user()->company_name ?? Auth::user()->name, 18)); ?></span>
                        <span class="pro-user-role"><?php echo e(Auth::user()->getAccountTypeLabel()); ?></span>
                    </div>
                </a>
                <ul class="dropdown-menu dropdown-menu-end mt-2">
                    <li><a class="dropdown-item" href="<?php echo e(route('pro.profile')); ?>"><i class="fas fa-user me-2"></i>Mon profil pro</a></li>
                    <li><a class="dropdown-item" href="<?php echo e(route('pro.subscription')); ?>"><i class="fas fa-crown me-2"></i>Mon abonnement</a></li>
                    <li><hr class="dropdown-divider"></li>
                    <li><a class="dropdown-item" href="<?php echo e(route('feed')); ?>"><i class="fas fa-home me-2"></i>Retour au feed</a></li>
                    <li><a class="dropdown-item" href="<?php echo e(route('settings.index')); ?>"><i class="fas fa-cog me-2"></i>Paramètres</a></li>
                    <li><hr class="dropdown-divider"></li>
                    <li>
    ...
    <aside class="pro-sidebar" id="proSidebar">
        ...
        <div class="pro-sidebar-section">
            ...
            <a href="<?php echo e(route('pro.dashboard')); ?>" class="pro-nav-item <?php echo e(request()->routeIs('pro.dashboard') ? 'active' : ''); ?>">
                <div class="pro-nav-icon" style="background: rgba(99,102,241,0.1); color: #6366f1;">
                    <i class="fas fa-th-large"></i>
                </div>
                Tableau de bord
            </a>
            <a href="<?php echo e(route('pro.profile')); ?>" class="pro-nav-item <?php echo e(request()->routeIs('pro.profile*') ? 'active' : ''); ?>">
        ...
        <div class="pro-sidebar-section">
            ...
            <a href="<?php echo e(route('pro.clients')); ?>" class="pro-nav-item <?php echo e(request()->routeIs('pro.clients*') ? 'active' : ''); ?>">
                <div class="pro-nav-icon" style="background: rgba(59,130,246,0.1); color: #3b82f6;">
                    <i class="fas fa-users"></i>
                </div>
                Mes clients
                <?php $clientCount = Auth::user()->proClients()->count(); ?>
                <?php if($clientCount > 0): ?>
                    <span class="pro-nav-badge info"><?php echo e($clientCount); ?></span>
                <?php endif; ?>
            </a>
            <a href="<?php echo e(route('pro.quotes')); ?>" class="pro-nav-item <?php echo e(request()->routeIs('pro.quotes*') ? 'active' : ''); ?>">
                <div class="pro-nav-icon" style="background: rgba(245,158,11,0.1); color: #f59e0b;">
                    <i class="fas fa-file-alt"></i>
                </div>
                Création de devis
                <?php $pendingQuotes = Auth::user()->proQuotes()->where('status', 'pending')->count(); ?>
                <?php if($pendingQuotes > 0): ?>
                    <span class="pro-nav-badge warning"><?php echo e($pendingQuotes); ?></span>
                <?php endif; ?>
            </a>
            <a href="<?php echo e(route('pro.invoices')); ?>" class="pro-nav-item <?php echo e(request()->routeIs('pro.invoices*') ? 'active' : ''); ?>">
                <div class="pro-nav-icon" style="background: rgba(236,72,153,0.1); color: #ec4899;">
                    <i class="fas fa-file-invoice-dollar"></i>
                </div>
                Création de facture
                <?php $unpaidInvoices = Auth::user()->proInvoices()->where('status', 'sent')->count(); ?>
                <?php if($unpaidInvoices > 0): ?>
                    <span class="pro-nav-badge danger"><?php echo e($unpaidInvoices); ?></span>
                <?php endif; ?>
            </a>
        </div>
        ...
        <div class="pro-sidebar-section">
            ...
            <a href="<?php echo e(route('pro.documents')); ?>" class="pro-nav-item <?php echo e(request()->routeIs('pro.documents*') ? 'active' : ''); ?>">
                <div class="pro-nav-icon" style="background: rgba(168,85,247,0.1); color: #a855f7;">
                    <i class="fas fa-folder-open"></i>
                </div>
                Documents
            </a>
            <a href="<?php echo e(route('pro.analytics')); ?>" class="pro-nav-item <?php echo e(request()->routeIs('pro.analytics*') ? 'active' : ''); ?>">
                <div class="pro-nav-icon" style="background: rgba(59,130,246,0.1); color: #3b82f6;">
                    <i class="fas fa-chart-line"></i>
                </div>
                Statistiques
            </a>
            <a href="<?php echo e(route('pro.agenda')); ?>" class="pro-nav-item <?php echo e(request()->routeIs('pro.agenda*') ? 'active' : ''); ?>">
                <div class="pro-nav-icon" style="background: rgba(245,158,11,0.1); color: #f59e0b;">
                    <i class="fas fa-calendar-check"></i>
                </div>
                Agenda
            </a>
            <a href="<?php echo e(route('pro.account-status')); ?>" class="pro-nav-item <?php echo e(request()->routeIs('pro.account-status*') ? 'active' : ''); ?>">
                <div class="pro-nav-icon" style="background: rgba(20,184,166,0.1); color: #14b8a6;">
                    <i class="fas fa-exchange-alt"></i>
                </div>
                Statut du compte
            </a>
            <a href="<?php echo e(route('pro.subscription')); ?>" class="pro-nav-item <?php echo e(request()->routeIs('pro.subscription*') ? 'active' : ''); ?>">
        ...
        <div class="pro-sidebar-section">
            ...
            <a href="<?php echo e(route('ads.create')); ?>" class="pro-nav-item">
                <div class="pro-nav-icon" style="background: rgba(34,197,94,0.1); color: #22c55e;">
                    <i class="fas fa-plus-circle"></i>
                </div>
                Publier une annonce
            </a>
            <a href="<?php echo e(route('messages.index')); ?>" class="pro-nav-item">
                <div class="pro-nav-icon" style="background: rgba(59,130,246,0.1); color: #3b82f6;">
                    <i class="fas fa-comments"></i>
                </div>
                Messagerie
                <?php if(Auth::user()->unreadMessagesCount() > 0): ?>
                    <span class="pro-nav-badge danger"><?php echo e(Auth::user()->unreadMessagesCount()); ?></span>
                <?php endif; ?>
            </a>
            <a href="<?php echo e(route('feed')); ?>" class="pro-nav-item">
        ...
        <?php $activeSub = Auth::user()->proSubscription; ?>
        <div class="pro-sidebar-section">
            <?php if($activeSub): ?>
                <div class="pro-sidebar-sub-card">
                    <h6><i class="fas fa-crown me-1"></i> <?php echo e($activeSub->getPlanLabel()); ?></h6>
                    <p>Actif jusqu'au <?php echo e($activeSub->ends_at->format('d/m/Y')); ?></p>
                    <p><?php echo e($activeSub->daysRemaining()); ?> jours restants</p>
                </div>
            <?php else: ?>
                <div class="pro-sidebar-sub-card" style="background: linear-gradient(135deg, #f97316, #ef4444);">
                    ...
                    <a href="<?php echo e(route('pro.subscription')); ?>" class="btn-upgrade">
...
<?php /**PATH C:\Users\PC\Desktop\MASSIWANI V2\resources\views/pro/layout.blade.php ENDPATH**/ ?>