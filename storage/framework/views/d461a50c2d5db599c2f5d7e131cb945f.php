<?php $__env->startSection('title', 'Boutique de Points - ProxiPro'); ?>
            ...
            <div class="pts-hero-inner">
                ...
                <div class="pts-balance-card">
                    ...
                    <div class="pts-balance-info">
                        ...
                        <div class="pts-balance-amount" id="user-points"><?php echo e(number_format($userPoints ?? 0, 0, ',', ' ')); ?> pts</div>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="pts-confirm-banner mb-4" id="successBanner">
            <div class="pts-confirm-inner">
                ...
                <div class="pts-confirm-text">
                    ...
                    <p>Votre nouveau solde est de <strong><?php echo e(number_format($userPoints ?? 0, 0, ',', ' ')); ?> points</strong>. Utilisez-les pour booster vos annonces !</p>
                </div>
        ...
        <div id="tab-buy" class="pts-tab-content active">
            ...
            <div class="row g-3">
                ...
                <div class="col-6 col-lg-4">
                    <div class="pts-pack <?php echo e($pack['badge'] === 'popular' ? 'pts-featured' : ''); ?>">
                        <?php if($pack['badge'] === 'popular'): ?>
                            <div class="pts-pack-ribbon popular">Populaire</div>
                        <?php elseif($pack['badge'] === 'best'): ?>
                            <div class="pts-pack-ribbon best">Meilleur prix</div>
                        <?php endif; ?>

                        <div class="pts-pack-head">
                            <div class="pts-pack-emoji"><?php echo e($pack['emoji']); ?></div>
                            <div class="pts-pack-pts"><?php echo e($pack['pts']); ?></div>
                            <div class="pts-pack-pts-label">points</div>
                        </div>

                        <div class="pts-pack-body">
                            <div class="pts-pack-desc"><?php echo e($pack['desc']); ?></div>
                            <div class="pts-pack-price"><?php echo e(number_format($pack['price'], 2, ',', ' ')); ?>€ <small>TTC</small></div>
                            <div class="pts-pack-unit">soit <?php echo e(number_format($pack['price'] / $pack['pts'], 2, ',', ' ')); ?>€ / point</div>
                            <div class="pts-pack-divider"></div>
                            <button class="btn-pts-buy" onclick="purchasePoints('<?php echo e($pack['key']); ?>', this)">
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (params.get('canceled') === 'true') {
        ...
        window.history.replaceState({}, '', '<?php echo e(route("pricing.index")); ?>');
    }

    // Show confirmation modal if purchase just succeeded
    <?php if(session('success')): ?>
    setTimeout(function() {
        var pts = '<?php echo e($userPoints ?? 0); ?>';
        document.getElementById('confirmBalance').textContent = pts + ' pts';
        document.getElementById('confirmMsg').textContent = '<?php echo e(session("success")); ?>';
...
function purchasePoints(productKey, btn) {
    ...
    fetch('<?php echo e(route("stripe.create-checkout")); ?>', {
        method: 'POST',
        headers: {
...
function loadSocialStatus() {
    fetch('<?php echo e(route("social.status")); ?>')
        .then(function(r) { return r.json(); })
...
function confirmShare() {
    ...
    fetch('<?php echo e(route("social.share")); ?>', {
        method: 'POST',
        headers: {
            'Content-Type': 'application/json',
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\PC\Desktop\MASSIWANI V2\resources\views/pricing/checkout.blade.php ENDPATH**/ ?>