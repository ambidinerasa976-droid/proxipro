...
<div class="hidden lg:flex w-[440px] shrink-0 bg-white border-r border-gray-200 flex-col sticky top-0 h-screen">
    <div class="flex flex-col h-full px-10 py-10">
        <!-- Logo -->
        <a href="<?php echo e(url('/')); ?>" class="flex items-center gap-2 mb-16">
        ...
        <!-- Footer -->
        <p class="text-xs text-gray-400">© <?php echo e(date('Y')); ?> ProxiPro</p>
    </div>
</div>
...
<div class="flex-1 flex items-start justify-center px-4 py-8 lg:px-12 overflow-y-auto">
    <div class="w-full max-w-lg fade-in">
        <!-- Logo mobile -->
        <a href="<?php echo e(url('/')); ?>" class="flex items-center gap-2 mb-8 lg:hidden">
            <span class="text-2xl">🔨</span>
            <span class="text-xl font-extrabold tracking-tight text-gray-900">ProxiPro</span>
        </a>
        ...
        <div class="bg-white rounded-2xl border border-gray-200 shadow-sm p-6 sm:p-8">
            ...
            <form method="POST" action="<?php echo e(route('register')); ?>" class="space-y-5" id="registerForm">
                <?php echo csrf_field(); ?>
                <input type="hidden" name="account_type" id="account_type" value="<?php echo e(old('account_type', 'particulier')); ?>">
                
                <!-- Anti-bot: Token de timing (chiffré) -->
                <input type="hidden" name="_form_token" value="<?php echo e(encrypt(time())); ?>">
                ...
                <div id="fields-professionnel" class="hidden space-y-5">
                    ...
                    <div>
                        ...
                        <input type="hidden" name="business_type" id="business_type" value="<?php echo e(old('business_type')); ?>">
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div>
                        ...
                        >
                            ...
                            <option value="BTP / Construction" <?php echo e(old('sector') == 'BTP / Construction' ? 'selected' : ''); ?>>BTP / Construction</option>
                            <option value="Services à la personne" <?php echo e(old('sector') == 'Services à la personne' ? 'selected' : ''); ?>>Services à la personne</option>
                            <option value="Informatique / Tech" <?php echo e(old('sector') == 'Informatique / Tech' ? 'selected' : ''); ?>>Informatique / Tech</option>
                            <option value="Transport / Logistique" <?php echo e(old('sector') == 'Transport / Logistique' ? 'selected' : ''); ?>>Transport / Logistique</option>
                            <option value="Commerce / Vente" <?php echo e(old('sector') == 'Commerce / Vente' ? 'selected' : ''); ?>>Commerce / Vente</option>
                            <option value="Restauration / Hôtellerie" <?php echo e(old('sector') == 'Restauration / Hôtellerie' ? 'selected' : ''); ?>>Restauration / Hôtellerie</option>
                            <option value="Santé / Bien-être" <?php echo e(old('sector') == 'Santé / Bien-être' ? 'selected' : ''); ?>>Santé / Bien-être</option>
                            <option value="Éducation / Formation" <?php echo e(old('sector') == 'Éducation / Formation' ? 'selected' : ''); ?>>Éducation / Formation</option>
                            <option value="Agriculture / Jardinage" <?php echo e(old('sector') == 'Agriculture / Jardinage' ? 'selected' : ''); ?>>Agriculture / Jardinage</option>
                ...
                <div>
                    ...
                    <input 
                        ...
                        placeholder="nom@exemple.com" value="<?php echo e(old('email')); ?>"
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="space-y-2 pt-1">
                    <label class="flex items-start gap-2.5 cursor-pointer">
                        ...
                        <span class="text-xs text-gray-600 leading-relaxed">
                            J'accepte les <a href="<?php echo e(url('/legal/terms')); ?>" class="text-blue-600 hover:underline">Conditions d'utilisation</a> et la <a href="<?php echo e(url('/legal/privacy')); ?>" class="text-blue-600 hover:underline">Politique de confidentialité</a> *
                        </span>
                    </label>
                    <label class="flex items-start gap-2.5 cursor-pointer">
            ...
            <p class="text-center text-sm text-gray-500 mt-6">
                Déjà inscrit ? <a href="<?php echo e(route('login')); ?>" class="font-semibold text-blue-600 hover:text-blue-700">Se connecter</a>
            </p>
        </div>
...
<?php echo $__env->make('layouts.auth', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\PC\Desktop\MASSIWANI V2\resources\views/auth/register.blade.php ENDPATH**/ ?>