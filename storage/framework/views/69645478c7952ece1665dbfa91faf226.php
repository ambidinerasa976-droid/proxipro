...
<aside class="sidebar-nav" id="sidebarNav">
    ...
    <nav class="sidebar-menu">
        <div class="menu-section">
            ...
            <a href="<?php echo e(route('profile.show')); ?>" class="menu-item <?php echo e(request()->routeIs('profile.*') ? 'active' : ''); ?>">
                <div class="menu-icon">
            ...
            <a href="<?php echo e(route('ads.myads')); ?>" class="menu-item <?php echo e(request()->routeIs('ads.myads') ? 'active' : ''); ?>">
                <div class="menu-icon">
            ...
            <a href="<?php echo e(route('ads.create')); ?>" class="menu-item menu-item-highlight <?php echo e(request()->routeIs('ads.create') ? 'active' : ''); ?>">
        ...
        <div class="menu-section">
            ...
            <a href="<?php echo e(route('messages.index')); ?>" class="menu-item <?php echo e(request()->routeIs('messages.*') ? 'active' : ''); ?>">
                <div class="menu-icon">
        ...
        <div class="menu-section">
            ...
            <a href="<?php echo e(route('points.dashboard')); ?>" class="menu-item <?php echo e(request()->routeIs('points.*') ? 'active' : ''); ?>">
                <div class="menu-icon">
            ...
            <a href="<?php echo e(route('home')); ?>#transactions-history" class="menu-item">
                <div class="menu-icon">
    ...
    <div class="sidebar-footer">
        ...
        <a href="<?php echo e(route('settings.index')); ?>" class="footer-link">
