...
<script>
    ...
    function handleVerifySubmit() {
        ...
        xhr.open('POST', '<?php echo e(route("verification.submit.ajax")); ?>', true);
    ...
    function handlePayment() {
        ...
        var xhr = new XMLHttpRequest();
        xhr.open('POST', '<?php echo e(route("verification.create.payment")); ?>', true);
...
<?php /**PATH C:\Users\PC\Desktop\MASSIWANI V2\resources\views/partials/verify-profile-modal.blade.php ENDPATH**/ ?>