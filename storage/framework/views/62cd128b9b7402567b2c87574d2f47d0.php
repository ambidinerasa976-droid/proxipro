            ...
            <div class="card-body">
                <div class="d-flex justify-content-between align-items-center">
                    <div>
                        ...
                        <h2 class="card-title mb-0"><?php echo e(number_format($generalStats['total_users'])); ?></h2>
                    </div>
            ...
            <div class="card-body">
                <div class="d-flex justify-content-between align-items-center">
                    <div>
                        ...
                        <h2 class="card-title mb-0"><?php echo e(number_format($generalStats['total_ads'])); ?></h2>
                    </div>
            ...
            <div class="card-body">
                <div class="d-flex justify-content-between align-items-center">
                    <div>
                        ...
                        <h2 class="card-title mb-0"><?php echo e(number_format($generalStats['active_ads'])); ?></h2>
                    </div>
            ...
            <div class="card-body">
                <div class="d-flex justify-content-between align-items-center">
                    <div>
                        ...
                        <h2 class="card-title mb-0"><?php echo e(number_format($generalStats['verified_users'])); ?></h2>
                    </div>
            ...
            <div class="card-body">
                <div class="d-flex justify-content-between align-items-center">
                    <div>
                        ...
                        <h2 class="card-title mb-0"><?php echo e(number_format($generalStats['premium_users'])); ?></h2>
                    </div>
                ...
                <div class="d-flex justify-content-between align-items-center">
                    <div>
                        ...
                        <h2 class="card-title mb-0">
                            <?php echo e($generalStats['total_users'] > 0 ? number_format($generalStats['verified_users'] / $generalStats['total_users'] * 100, 1) : 0); ?>%
                        </h2>
                    </div>
                ...
                <table class="table table-hover mb-0">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="<?php echo e(route('admin.users.show', $user->id)); ?>" class="text-decoration-none">
                                    <?php echo e($user->name); ?>

                                </a>
                            </td>
                            <td class="text-end pe-4">
                                <span class="badge bg-primary"><?php echo e($user->ads_count); ?></span>
                            </td>
                        </tr>
    ...
    <div class="col-lg-6">
        <div class="card border-0 shadow-sm h-100">
            ...
            <div class="card-body">
                ...
                ?>
                <?php $__empty_1 = true; $__currentLoopData = $usersByType; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $type): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <?php
                    ...
                    <div class="mb-3">
                        <div class="d-flex justify-content-between mb-1">
                            <span>
                                <i class="fas <?php echo e($typeConfig['icon']); ?> text-<?php echo e($typeConfig['color']); ?> me-2"></i>
                                <?php echo e($typeConfig['label']); ?>

                            </span>
                            <span class="fw-bold"><?php echo e($type->count); ?> (<?php echo e(number_format($percentage, 1)); ?>%)</span>
                        </div>
                        <div class="progress" style="height: 8px;">
                            <div class="progress-bar bg-<?php echo e($typeConfig['color']); ?>" style="width: <?php echo e($percentage); ?>%"></div>
                        </div>
                    </div>
...
<div class="card border-0 shadow-sm mt-4 mb-4">
    <div class="card-header bg-white border-0 py-3 d-flex justify-content-between align-items-center">
        <h5 class="mb-0">
            ...
            <span class="badge bg-primary ms-2"><?php echo e($allUsers->count()); ?></span>
        </h5>
    ...
    <div class="card-body p-0">
        ...
        <div class="d-flex flex-wrap gap-3 px-4 py-3 bg-light border-bottom">
            <div class="d-flex align-items-center gap-2">
                ...
                <small><strong><?php echo e($allUsers->where('is_verified', true)->count()); ?></strong> vérifiés</small>
            </div>
            <div class="d-flex align-items-center gap-2">
                ...
                <small><strong><?php echo e($allUsers->where('is_verified', false)->count()); ?></strong> non vérifiés</small>
            </div>
            <div class="d-flex align-items-center gap-2">
                ...
                <small><strong><?php echo e($allUsers->filter(fn($u) => $u->isProfessionnel())->count()); ?></strong> professionnels</small>
            </div>
            <div class="d-flex align-items-center gap-2">
                ...
                <small><strong><?php echo e($allUsers->where('profile_completion', '>=', 80)->count()); ?></strong> profils complets (≥80%)</small>
            </div>
            <div class="d-flex align-items-center gap-2">
                ...
                <small><strong><?php echo e($allUsers->where('profile_completion', '<', 50)->count()); ?></strong> profils incomplets (&lt;50%)</small>
            </div>
        </div>
        ...
        <div class="table-responsive" style="max-height: 600px; overflow-y: auto;">
            <table class="table table-hover align-middle mb-0" id="userCensusTable">
                ...
                <tbody>
                    <?php $__currentLoopData = $allUsers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $u): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr class="user-census-row" 
                        data-name="<?php echo e(strtolower($u->name)); ?>" 
                        data-email="<?php echo e(strtolower($u->email)); ?>"
                        data-verified="<?php echo e($u->is_verified ? 'verified' : 'unverified'); ?>"
                        data-active="<?php echo e(($u->is_active ?? true) ? 'active' : 'inactive'); ?>"
                        data-completion="<?php echo e($u->profile_completion); ?>"
                        style="cursor: pointer;"
                        onclick="window.location='<?php echo e(route('admin.users.show', $u->id)); ?>'">
                        <td class="ps-4 text-muted small"><?php echo e($index + 1); ?></td>
                        <td>
                            <div class="d-flex align-items-center gap-2">
                                <?php if($u->avatar): ?>
                                    <img src="<?php echo e(asset('storage/' . $u->avatar)); ?>" alt="" class="rounded-circle" style="width: 32px; height: 32px; object-fit: cover;">
                                <?php else: ?>
                                    <div class="rounded-circle d-flex align-items-center justify-content-center text-white" style="width: 32px; height: 32px; font-size: 0.7rem; font-weight: 700; background: <?php echo e($u->is_verified ? '#10b981' : '#94a3b8'); ?>;">
                        ...
                        <td style="min-width: 180px;">
                            ...
                            <div class="d-flex align-items-center gap-2">
                                <div class="progress flex-grow-1" style="height: 6px;">
                                    <div class="progress-bar bg-<?php echo e($barColor); ?>" style="width: <?php echo e($pct); ?>%"></div>
                                </div>
                                <span class="fw-bold text-<?php echo e($barColor); ?>" style="font-size: 0.75rem; min-width: 35px;"><?php echo e($pct); ?>%</span>
                            </div>
                            <small class="text-muted" style="font-size: 0.7rem;"><?php echo e($u->profile_filled); ?>/<?php echo e($u->profile_total); ?> champs</small>
                        </td>
                        <td>
                            <span class="badge bg-light text-dark border"><?php echo e($u->ads_count); ?></span>
                        </td>
                        <td>
                            <small class="text-muted"><?php echo e($u->created_at->format('d/m/Y')); ?></small>
                        </td>
                        <td class="text-end pe-4" onclick="event.stopPropagation();">
                            <a href="<?php echo e(route('admin.users.show', $u->id)); ?>" class="btn btn-sm btn-outline-primary py-0 px-2" title="Voir le profil">
...
document.addEventListener('DOMContentLoaded', function() {
    // Données PHP vers JS
    const registrationsData = <?php echo json_encode($registrationsByDay, 15, 512) ?>;
    const adsData = <?php echo json_encode($adsByDay, 15, 512) ?>;
    const categoriesData = <?php echo json_encode($adsByCategory, 15, 512) ?>;
    const plansData = <?php echo json_encode($usersByPlan, 15, 512) ?>;
...
<?php echo $__env->make('admin.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\PC\Desktop\MASSIWANI V2\resources\views/admin/stats.blade.php ENDPATH**/ ?>